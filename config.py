...
class Config:
    ...
    risk_toxic_regime_filter_enabled: bool = _get_bool("RISK_TOXIC_REGIME_FILTER_ENABLED", True)
    risk_toxic_regime_names: str = os.getenv("RISK_TOXIC_REGIME_NAMES", "SIDEWAYS / CHOPPY")
    risk_toxic_regime_position_multiplier: float = _get_float("RISK_TOXIC_REGIME_POSITION_MULTIPLIER", 0.25)
    risk_toxic_regime_confidence_multiplier: float = _get_float("RISK_TOXIC_REGIME_CONFIDENCE_MULTIPLIER", 0.50)
    risk_toxic_regime_hard_block: bool = _get_bool("RISK_TOXIC_REGIME_HARD_BLOCK", False)
